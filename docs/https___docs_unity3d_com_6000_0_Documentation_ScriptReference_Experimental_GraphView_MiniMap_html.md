* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap.html
...
---|---  
[anchored](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-anchored.html) | True if the MiniMap is pinned or achored (non-movable). False if you can drag and move it around.  
[graphView](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-graphView.html) | The GraphView that the MiniMap is attached to.  
[maxHeight](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-maxHeight.html) | Max height.  
[maxWidth](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-maxWidth.html) | Max width.  
[windowed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-windowed.html) | Set to true when the MiniMap displays in a separate window. Set to false when the MiniMap displays in the GraphView.  
[zoomFactorTextChanged](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-zoomFactorTextChanged.html) | Callback for when the zoom factor text has changed.  
### Constructors
Constructor | Description  
---|---  
[MiniMap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap-ctor.html) | MiniMap's constructor.  
### Public Methods
Method | Description  
---|---  
[BuildContextualMenu](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap.BuildContextualMenu.html) | Add menu items to the MiniMap contextual menu.  
[OnResized](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.MiniMap.OnResized.html) | Call this method after a user has resized a MiniMap to let the MiniMap know it needs to get updated.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
