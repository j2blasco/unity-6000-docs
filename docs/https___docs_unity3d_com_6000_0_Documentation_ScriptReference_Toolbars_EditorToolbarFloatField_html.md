* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarFloatField.html

# EditorToolbarFloatField
class in UnityEditor.Toolbars
/
Inherits from:[UIElements.FloatField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField.html)
Leave feedback
Suggest a change
## Success!
...
Cancel
### Description
A float field used with [EditorToolbarElementAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarElementAttribute.html).
### Constructors
Constructor | Description  
---|---  
[EditorToolbarFloatField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarFloatField-ctor.html) | Creates a float field visual element that is styled to match a toolbar in an UnityEditor.Overlays.Overlay.  
### Inherited Members
### Static Properties
...
[inputUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField-inputUssClassName.html) |  USS class name of input elements in elements of this type.   
[labelUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField-labelUssClassName.html) |  USS class name of labels in elements of this type.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField-ussClassName.html) |  USS class name of elements of this type.   
...
[ApplyInputDeviceDelta](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField.ApplyInputDeviceDelta.html) |  Applies the values of a 3D delta and a speed from an input device.   
...
[StringToValue](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField.StringToValue.html) |  Converts a string to a float.   
[ValueToString](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.FloatField.ValueToString.html) |  Converts the given float to a string.   
