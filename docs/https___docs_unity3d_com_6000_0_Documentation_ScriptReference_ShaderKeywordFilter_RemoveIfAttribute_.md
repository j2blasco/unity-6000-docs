* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/ShaderKeywordFilter.RemoveIfAttribute-ctor.html

# RemoveIfAttribute Constructor
Leave feedback
Suggest a change
## Success!
...
Cancel
## Declaration
public RemoveIfAttribute(object condition, bool overridePriority, string filePath, int lineNumber, params string[] keywordNames); 
### Parameters
