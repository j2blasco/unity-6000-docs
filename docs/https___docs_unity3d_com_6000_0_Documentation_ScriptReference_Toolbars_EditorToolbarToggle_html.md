* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle.html

# EditorToolbarToggle
class in UnityEditor.Toolbars
/
Inherits from:[UIElements.ToolbarToggle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarToggle.html)
Leave feedback
Suggest a change
## Success!
...
Cancel
### Description
A toggle used with [EditorToolbarElementAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarElementAttribute.html).
### Static Properties
Property | Description  
---|---  
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-ussClassName.html) | USS Class Name used to style the EditorToolbarToggle.  
### Properties
Property | Description  
---|---  
[icon](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-icon.html) | The icon associated with the toggle.  
[offIcon](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-offIcon.html) | The icon associated with the toggle when the value is false.  
[onIcon](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-onIcon.html) | The icon associated with the toggle when the value is true.  
[text](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-text.html) | The text associated with the toggle.  
[textIcon](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-textIcon.html) | The text icon associated with the toggle.  
### Constructors
Constructor | Description  
---|---  
[EditorToolbarToggle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle-ctor.html) | Constructor.  
### Public Methods
Method | Description  
---|---  
[SetValueWithoutNotify](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Toolbars.EditorToolbarToggle.SetValueWithoutNotify.html) | Allow to set a value without being notified of the change, if any.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
...
[checkmarkUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-checkmarkUssClassName.html) |  USS class name of Images in Toggle elements.   
[inputUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-inputUssClassName.html) |  USS class name of input elements in Toggle elements.   
[labelUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-labelUssClassName.html) |  USS class name for Labels in Toggle elements.   
[mixedValuesUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-mixedValuesUssClassName.html) |  USS class name of Toggle elements that have mixed values   
[noTextVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-noTextVariantUssClassName.html) |  USS class name of Toggle elements that have no text.   
[textUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-textUssClassName.html) |  USS class name of Text elements in Toggle elements.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Toggle-ussClassName.html) |  USS class name for Toggle elements.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarToggle-ussClassName.html) |  USS class name of elements of this type.   
