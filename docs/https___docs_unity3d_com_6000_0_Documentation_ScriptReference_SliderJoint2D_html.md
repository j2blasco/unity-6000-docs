* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D.html
...
Cancel
### Description
Joint that restricts the motion of a [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html) object to a single line.
Additional resources: [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html), [DistanceJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/DistanceJoint2D.html), [HingeJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D.html), [SpringJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D.html), [JointTranslationLimits2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/JointTranslationLimits2D.html).
### Properties
Property | Description  
---|---  
[angle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-angle.html) | The angle of the line in space (in degrees).  
[autoConfigureAngle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-autoConfigureAngle.html) | Should the angle be calculated automatically?  
[jointSpeed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-jointSpeed.html) | The current joint speed.  
[jointTranslation](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-jointTranslation.html) | The current joint translation.  
[limits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-limits.html) | Restrictions on how far the joint can slide in each direction along the line.  
[limitState](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-limitState.html) | Gets the state of the joint limit.  
[motor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-motor.html) | Parameters for a motor force that is applied automatically to the Rigibody2D along the line.  
[referenceAngle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-referenceAngle.html) | The angle (in degrees) referenced between the two bodies used as the constraint for the joint.  
[useLimits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-useLimits.html) | Should motion limits be used?  
[useMotor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D-useMotor.html) | Should a motor force be applied automatically to the Rigidbody2D?  
### Public Methods
Method | Description  
---|---  
[GetMotorForce](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D.GetMotorForce.html) | Gets the motor force of the joint given the specified timestep.  
### Inherited Members
### Properties
Property | Description  
---|---  
