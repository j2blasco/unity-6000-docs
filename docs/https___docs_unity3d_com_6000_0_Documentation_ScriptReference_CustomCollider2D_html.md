* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html
...
Cancel
### Description
Represents a [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) that is configured by assigning [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html) geometry to it via a [PhysicsShapeGroup2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShapeGroup2D.html).
Unlike all other [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) which are defined indirectly by controlling geometric parameters such as the size of a Box or the radius of a Circle, here the [CustomCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html) is defined entirely by adding, removing and modifying [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html). This results in a fully customized [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) containing an unlimited number of low-level [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html) which can represent any type of shape or shapes, or emulate any other existing [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) such as the [CircleCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CircleCollider2D.html), [BoxCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/BoxCollider2D.html), [CapsuleCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CapsuleCollider2D.html), [EdgeCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/EdgeCollider2D.html), [CompositeCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CompositeCollider2D.html) or [TilemapCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TilemapCollider2D.html).  
  
Alongside the customized geometry, there is full support for all existing [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) functionality such as [triggers](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D-isTrigger.html), [physics materials](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D-sharedMaterial.html), queries etc.  
  
When assigning [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html) to the [CustomCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html), you can do so either during Edit mode or Play mode.  
  
When modifying the [CustomCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html) during Edit mode, all assigned [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html) and associated [vertices](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Vector2.html) will be saved with the Unity [Scene](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SceneManagement.Scene.html). When the Unity [Scene](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SceneManagement.Scene.html) is loaded again, the [CustomCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html) will maintain its configuration. In this way, it acts like any other [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) that you make changes to during Edit mode. Using this ability, Edit mode authoring scripts can be used to create custom geometry.  
  
When modifing the [CustomCollider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.html) during Play mode, all assigned [PhysicsShape2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PhysicsShape2D.html) and associated [vertices](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Vector2.html) will be lost when exiting Play mode. This acts like any other [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html).
### Properties
Property | Description  
---|---  
[customShapeCount](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D-customShapeCount.html) | The total number of custom PhysicsShape2D assigned to the Collider. (Read Only)  
[customVertexCount](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D-customVertexCount.html) | The total number of vertices used by the Collider. (Read Only)  
### Public Methods
Method | Description  
---|---  
[ClearCustomShapes](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.ClearCustomShapes.html) | Deletes all the shapes and associated vertices for those shapes from the Collider.  
[GetCustomShapes](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.GetCustomShapes.html) | Gets all the physics shapes and vertices in the Collider and places them in the specified PhysicsShapeGroup2D.  
[SetCustomShape](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.SetCustomShape.html) | Sets a single shape and all associated shape vertices from the specified physicsShapeGroup into the Collider.  
[SetCustomShapes](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/CustomCollider2D.SetCustomShapes.html) | Sets all the shapes and vertices in the Collider to those represented by the specified PhysicsShapeGroup2D.  
### Inherited Members
### Properties
Property | Description  
---|---  
