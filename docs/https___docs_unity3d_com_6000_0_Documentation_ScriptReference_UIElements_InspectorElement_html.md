* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement.html
...
---|---  
[customInspectorUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-customInspectorUssClassName.html) |  USS class name of custom inspector elements in elements of this type.   
[debugInternalVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-debugInternalVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in debug internal mode.   
[debugVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-debugVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in debug USS mode.   
[iMGUIContainerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-iMGUIContainerUssClassName.html) |  USS class name of IMGUI containers in elements of this type.   
[iMGUICustomVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-iMGUICustomVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in IMGUI custom mode.   
[iMGUIDefaultVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-iMGUIDefaultVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in IMGUI default mode.   
[iMGUIInspectorVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-iMGUIInspectorVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in IMGUI inspector mode.   
[noInspectorFoundVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-noInspectorFoundVariantUssClassName.html) |  USS class name of elements of this type, when no inspector is found.   
[uIECustomVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-uIECustomVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in UIElements custom mode.   
[uIEDefaultVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-uIEDefaultVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in UIElements default mode.   
[uIEInspectorVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-uIEInspectorVariantUssClassName.html) |  USS class name of elements of this type, when they are displayed in UIElements inspector mode.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-ussClassName.html) |  USS class name of elements of this type.   
### Constructors
Constructor | Description  
---|---  
[InspectorElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement-ctor.html) |  Initialized a new instance of InspectorElement.   
### Static Methods
Method | Description  
---|---  
[FillDefaultInspector](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.InspectorElement.FillDefaultInspector.html) |  Adds default inspector property fields under a container VisualElement.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
