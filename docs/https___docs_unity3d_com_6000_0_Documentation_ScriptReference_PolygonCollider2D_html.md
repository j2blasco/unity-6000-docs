* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D.html
...
---|---  
[autoTiling](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D-autoTiling.html) | Determines whether the PolygonCollider2D's shape is automatically updated based on a SpriteRenderer's tiling properties.  
[pathCount](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D-pathCount.html) | The number of paths in the polygon.  
[points](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D-points.html) | Corner points that define the collider's shape in local space.  
[useDelaunayMesh](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D-useDelaunayMesh.html) | When the value is true, the Collider uses an additional Delaunay triangulation step to produce the Collider mesh. When the value is false, this additional step does not occur.  
### Public Methods
Method | Description  
---|---  
[CreatePrimitive](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D.CreatePrimitive.html) | Creates as regular primitive polygon with the specified number of sides.  
[GetPath](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D.GetPath.html) | Gets a path from the Collider by its index.  
[GetTotalPointCount](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D.GetTotalPointCount.html) | Return the total number of points in the polygon in all paths.  
[SetPath](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PolygonCollider2D.SetPath.html) | Define a path by its constituent points.  
### Inherited Members
### Properties
Property | Description  
---|---  
