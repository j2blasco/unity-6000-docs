* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerEventBase_1.html
...
Implements interfaces:[IPointerEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.IPointerEvent.html)
Suggest a change
## Success!
...
A cycle of pointer events occurs as follows: 
  * The user presses a mouse button, touches the screen, or otherwise causes a [PointerDownEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerDownEvent.html) to be sent.
  * If the user changes the pointer's state, a [PointerMoveEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerMoveEvent.html) is sent. Multiple PointerMove events are sent if multiple properties of the pointer change.
  * If the user cancels the loop, a [PointerCancelEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerCancelEvent.html) is sent.
  * If the user doesn't cancel the loop, and either releases the last button pressed or releases the last touch, a [PointerUpEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerUpEvent.html) is sent.
  * If the initial [PointerDownEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerDownEvent.html) and the [PointerUpEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PointerUpEvent.html) occur on the same visual element, a [ClickEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ClickEvent.html) is sent.
