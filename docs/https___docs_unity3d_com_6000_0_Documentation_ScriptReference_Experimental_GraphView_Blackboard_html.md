* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard.html
...
---|---  
[addItemRequested](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-addItemRequested.html) | Called when user clicks on the Add button of this Blackboard.  
[contentContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-contentContainer.html) | The content container of this Blackboard.  
[editTextRequested](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-editTextRequested.html) | Called when user has edited the text of this BlackboardField.  
[graphView](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-graphView.html) | The GraphView that the Blackboard is attached to.  
[moveItemRequested](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-moveItemRequested.html) | Called when user has dragged and dropped a BlackboardField to a new location inside its BlackboardSection.  
[scrollable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-scrollable.html) | Indicates whether the content of this Blackboard can be vertically scrolled by user. It is false by default.  
[selection](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-selection.html) | All selected elements in the GraphView that the Blackboard is attached to.  
[subTitle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-subTitle.html) | The subtitle of this Blackboard.  
[title](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-title.html) | The title of this Blackboard.  
[windowed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-windowed.html) | Set to true when the Blackboard displays in a separate window. Set to false when the Blackboard displays in the GraphView.  
### Constructors
Constructor | Description  
---|---  
[Blackboard](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard-ctor.html) | Constructs a Blackboard.  
### Public Methods
Method | Description  
---|---  
[AddToSelection](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard.AddToSelection.html) | Adds an element to the selection in the GraphView that the Blackboard is attached to.  
[ClearSelection](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard.ClearSelection.html) | Clears the selection in the GraphView that the Blackboard is attached to.  
[RemoveFromSelection](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Blackboard.RemoveFromSelection.html) | Removes an element from the selection in the GraphView that the Blackboard is attached to.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
