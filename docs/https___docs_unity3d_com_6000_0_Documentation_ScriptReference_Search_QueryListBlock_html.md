* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock.html

# QueryListBlock
class in UnityEditor.Search
/
Inherits from:[Search.QueryBlock](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock.html)
Leave feedback
Suggest a change
## Success!
...
In example, if your [SearchProvider](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.SearchProvider.html) has a filter named `color` for which the value can be yellow, red or pink. Then you'll use the [QueryListBlockAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlockAttribute.html) to have this filter be displayed as a block that when clicked will show a fixed set of values to be picked from.
### Properties
Property | Description  
---|---  
[category](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock-category.html) | Block category.  
[icon](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock-icon.html) | Icon displayed in the query builder block widget.  
[id](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock-id.html) | Block id.  
### Public Methods
Method | Description  
---|---  
[Apply](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock.Apply.html) | Apply proposition to the block.  
[GetPropositions](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryListBlock.GetPropositions.html) | Returns propositions when the list block is clicked.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
...
[context](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-context.html) | Search context that composed this query block.  
[name](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-name.html) | Name of the block.  
[op](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-op.html) | Filter operator (i.e. :, =, <, >, etc.) of the block if any.  
[source](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-source.html) | Query builder source that compose this block.  
[value](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-value.html) | Value of the block.  
...
[ToString](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock.ToString.html) | Returns the text filter of the block.  
