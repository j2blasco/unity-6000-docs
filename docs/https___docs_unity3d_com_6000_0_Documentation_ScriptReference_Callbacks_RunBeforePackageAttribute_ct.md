* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Callbacks.RunBeforePackageAttribute-ctor.html

# RunBeforePackageAttribute Constructor
Leave feedback
Suggest a change
## Success!
...
Cancel
## Declaration
public RunBeforePackageAttribute(string packageName); 
### Parameters
