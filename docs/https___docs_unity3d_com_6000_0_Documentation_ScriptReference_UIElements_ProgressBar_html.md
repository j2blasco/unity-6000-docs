* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ProgressBar.html

# ProgressBar
class in UnityEngine.UIElements
/
Inherits from:[UIElements.AbstractProgressBar](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar.html)
/
...
Cancel
### Description
A control that displays the progress between a lower and upper bound value. For more information, refer to [UXML element ProgressBar](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-ProgressBar.html). 
```
 public ProgressBar[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ProgressBar.html) CreateProgressBar()
 {
     var progressBar = new ProgressBar[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ProgressBar.html)
     {
         title = "Progress[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Progress.html)",
         lowValue = 0f,
         highValue = 100f,
         value = 0f
     };  
...
---|---  
[backgroundUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-backgroundUssClassName.html) |  USS Class Name used to style the background of the ProgressBar.   
[containerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-containerUssClassName.html) |  USS Class Name used to style the container of the ProgressBar.   
[progressUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-progressUssClassName.html) |  USS Class Name used to style the progress bar of the ProgressBar.   
[titleContainerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-titleContainerUssClassName.html) |  USS Class Name used to style the container of the title of the ProgressBar.   
[titleUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-titleUssClassName.html) |  USS Class Name used to style the title of the ProgressBar.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-ussClassName.html) |  USS Class Name used to style the ProgressBar.   
...
Property | Description  
---|---  
[highValue](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-highValue.html) |  Sets the maximum value of the ProgressBar.   
[lowValue](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-lowValue.html) |  Sets the minimum value of the ProgressBar.   
[title](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-title.html) |  Sets the title of the ProgressBar that displays in the center of the control.   
[value](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar-value.html) |  Sets the progress value. If the value has changed, dispatches an ChangeEvent_1 of type float.   
...
Method | Description  
---|---  
[SetValueWithoutNotify](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.AbstractProgressBar.SetValueWithoutNotify.html) |  Sets the progress value.   
