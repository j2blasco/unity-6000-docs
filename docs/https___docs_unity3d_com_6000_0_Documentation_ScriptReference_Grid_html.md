* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid.html
...
Implements the interface [GridLayout](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/GridLayout.html).
### Properties
Property | Description  
---|---  
[cellGap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid-cellGap.html) | The size of the gap between each cell in the Grid.  
[cellLayout](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid-cellLayout.html) | The layout of the cells in the Grid.  
[cellSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid-cellSize.html) | The size of each cell in the Grid.  
[cellSwizzle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid-cellSwizzle.html) | The cell swizzle for the Grid.  
### Public Methods
Method | Description  
---|---  
[GetCellCenterLocal](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid.GetCellCenterLocal.html) | Get the logical center coordinate of a grid cell in local space.  
[GetCellCenterWorld](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid.GetCellCenterWorld.html) | Get the logical center coordinate of a grid cell in world space.  
### Static Methods
Method | Description  
---|---  
[InverseSwizzle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid.InverseSwizzle.html) | Does the inverse swizzle of the given position for given swizzle order.  
[Swizzle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Grid.Swizzle.html) | Swizzles the given position with the given swizzle order.  
### Inherited Members
### Properties
Property | Description  
---|---  
