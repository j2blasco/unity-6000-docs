* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TileBase.html
...
Cancel
### Description
Base class for a tile in the [Tilemap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.Tilemap.html).
Inherit from this to implement your custom tile to be placed in a [Tilemap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.Tilemap.html) component.
### Public Methods
Method | Description  
---|---  
[GetTileAnimationData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TileBase.GetTileAnimationData.html) | Retrieves any tile animation data from the scripted tile.  
[GetTileData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TileBase.GetTileData.html) | Retrieves any tile rendering data from the scripted tile.  
[RefreshTile](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TileBase.RefreshTile.html) | This method is called when the tile is refreshed.  
[StartUp](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Tilemaps.TileBase.StartUp.html) | StartUp is called on the first frame of the running Scene.  
### Inherited Members
### Properties
