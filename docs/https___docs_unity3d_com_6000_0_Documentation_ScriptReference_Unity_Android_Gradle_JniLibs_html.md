* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.JniLibs.html
...
For more information about the file, see Android's documentation: [JniLibs](https://developer.android.com/reference/tools/gradle-api/com/android/build/api/dsl/JniLibsPackaging)
### Properties
Property | Description  
---|---  
[UseLegacyPackaging](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.JniLibs.UseLegacyPackaging.html) | Whether to use the legacy convention of compressing all .so files in the APK. If null, .so files will be uncompressed and page-aligned when minSdk >= 23.  
### Constructors
Constructor | Description  
---|---  
[JniLibs](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.JniLibs-ctor.html) | Element constructor.  
### Inherited Members
### Public Methods
Method | Description  
---|---  
