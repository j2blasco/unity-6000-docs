* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Shader.GetGlobalFloatArray.html

#  [Shader](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Shader.html).GetGlobalFloatArray
Leave feedback
Suggest a change
## Success!
...
### Description
Gets a global float array for all shaders previously set using [SetGlobalFloatArray](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Shader.SetGlobalFloatArray.html).
* * *
## Declaration
...
name | The name of the property.  
### Description
Fetches a global float array into a list.
