* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh-uv.html

#  [Mesh](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.html).uv
Leave feedback
Suggest a change
## Success!
...
This channel is also commonly called "UV0". It maps to the shader semantic `TEXCOORD0`. When you call [Mesh.HasVertexAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.HasVertexAttribute.html), this channel corresponds to [VertexAttribute.TexCoord0](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rendering.VertexAttribute.TexCoord0.html).  
