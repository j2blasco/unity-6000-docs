* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.html
...
---|---  
[Collapsed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.Collapsed.html) | Whether the placemat is collapsed (true) or expanded (false).  
[CollapsedElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.CollapsedElements.html) | The list of elements hidden by the placemat when collapsed. The list is empty when the placemat is expanded.  
[CollapsedSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.CollapsedSize.html) | The size of the placemat when collapsed.  
[Color](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.Color.html) | The color of the placemat.  
[ExpandedPosition](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.ExpandedPosition.html) | The rect representing the expanded placemat, regardless of the current collapsed state.  
[title](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat-title.html) | The title of the placemat.  
[UncollapsedSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.UncollapsedSize.html) | The size of the placemat when expanded.  
[ZOrder](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.ZOrder.html) | The Z order of the placemat in the PlacematContainer.  
### Constructors
Constructor | Description  
---|---  
[Placemat](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat-ctor.html) | Constructor.  
### Public Methods
Method | Description  
---|---  
[SetPosition](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.SetPosition.html) | Sets the placemat position  
[StartEditTitle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.StartEditTitle.html) | Sets the focus to the title of placemat and sets the title for editing.  
### Protected Methods
Method | Description  
---|---  
[BuildContextualMenu](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.BuildContextualMenu.html) | Adds menu items to the placemat contextual menu.  
[SetCollapsedElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.SetCollapsedElements.html) | Sets the list of collapsed elements. This method is not meant to be called.  
### Static Methods
Method | Description  
---|---  
[ComputeElementBounds](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Placemat.ComputeElementBounds.html) | Calculates the bounds of a list of graph elements.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
