* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Input-accelerationEvents.html

#  [Input](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Input.html).accelerationEvents
Leave feedback
Suggest a change
## Success!
...
public class Example : MonoBehaviour[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MonoBehaviour.html)
{
    ...
    void Update[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PlayerLoop.Update.html)()
    {
        ...
        foreach (AccelerationEvent[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AccelerationEvent.html) accEvent in Input.accelerationEvents[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Input-accelerationEvents.html))
        {
