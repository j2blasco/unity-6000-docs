* Source: https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-Vector2Field.html
...
[](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-UnsignedIntegerField.html)
UnsignedIntegerField
[](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-Vector2IntField.html)
Vector2IntField
# Vector2Field
A Vector2Field lets users enter a [Vector2](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Vector2.html) value. 
**Note** : To align a Vector2Field with other fields in an **Inspector** A Unity window that displays information about the currently selected GameObject, asset or project settings, allowing you to inspect and edit the values. [More info](https://docs.unity3d.com/6000.0/Documentation/Manual/UsingTheInspector.html)  
...
You can create a Vector2Field with UI Builder, UXML, and C#. The following C# example creates a Vector2Field and sets the default value to `(15.5, 12.5)`:
```
Vector2Field myElement = new Vector2Field("Label text");
// Set the default value to (15.5, 12.5).
myElement.value = new Vector2(15.5f, 12.5f);

```

## Example
The following UXML example creates a Vector2Field with a placeholder:
```
<UXML xmlns="UnityEngine.UIElements" xmlns:uie="UnityEditor.UIElements">
    <Vector2Field label="UXML Field" name="the-uxml-field" />
</UXML>

```

The following C# example illustrates some of the customizable functionalities of the Vector2Field:
```
/// <sample>
...
**C# class** : [`Vector2Field`](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Vector2Field.html)  
...
---|---|---  
`ussClassName` | `.unity-vector2-field` | USS class name of elements of this type.  
`labelUssClassName` | `.unity-vector2-field__label` | USS class name of labels in elements of this type.  
`inputUssClassName` | `.unity-vector2-field__input` | USS class name of input elements in elements of this type.  
...
## Additional resources
  * [Vector2IntField](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-Vector2IntField.html)
