* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D.html
...
Cancel
### Description
The joint attempts to move a [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html) to a specific target position.
This joint is the only joint that doesn't connect two [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html) together. Instead, it only operates on the single body it is connected to.  
  
When connected, it will attempt to move the body to a specified [target](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-target.html) position. When setting a target you can also set the [anchor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-anchor.html) position which is a point relative to the [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html) where forces will be applied.  
  
The joint moves the body using a configurable spring that has a force limit.  
  
An example usage for this joint might be to enable [Collider2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Collider2D.html) to be dragged, selecting an anchor point and moving the body to the position under the mouse.
### Properties
Property | Description  
---|---  
[anchor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-anchor.html) | The local-space anchor on the rigid-body the joint is attached to.  
[autoConfigureTarget](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-autoConfigureTarget.html) | Should the target be calculated automatically?  
[dampingRatio](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-dampingRatio.html) | The amount by which the target spring force is reduced in proportion to the movement speed.  
[frequency](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-frequency.html) | The frequency at which the target spring oscillates around the target position.  
[maxForce](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-maxForce.html) | The maximum force that can be generated when trying to maintain the target joint constraint.  
[target](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TargetJoint2D-target.html) | The world-space position that the joint will attempt to move the body to.  
### Inherited Members
### Properties
Property | Description  
---|---  
