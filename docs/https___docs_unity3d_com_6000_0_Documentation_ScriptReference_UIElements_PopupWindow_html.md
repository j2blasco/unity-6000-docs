* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PopupWindow.html
...
Cancel
### Description
Styled visual text element. This element doesn't have any functionality. It's just a container with a border and a title, rather than a window or popup. For more information, refer to [UXML element PopupWindow](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-PopupWindow.html). 
```
 var popupWindow = new UnityEngine.UIElements.PopupWindow() { text = "Title" };
 popupWindow.Add(new Button[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Button.html)());
...
---|---  
[contentUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PopupWindow-contentUssClassName.html) |  USS class name of content elements in elements of this type.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PopupWindow-ussClassName.html) |  USS class name of elements of this type.   
### Constructors
Constructor | Description  
---|---  
[PopupWindow](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PopupWindow-ctor.html) |  Initializes and returns an instance of PopupWindow.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
