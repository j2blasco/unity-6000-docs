* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color-clear.html

#  [Color](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color.html).clear
Leave feedback
Suggest a change
## Success!
...
public class Example : MonoBehaviour[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MonoBehaviour.html)
{
    ...
    //Run your mouse over the GameObject[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/GameObject.html) to change the Renderer[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Renderer.html)'s material color to clear
    void OnMouseOver()
    {
        m_Renderer.material.color = Color.clear[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color-clear.html);
    }  
