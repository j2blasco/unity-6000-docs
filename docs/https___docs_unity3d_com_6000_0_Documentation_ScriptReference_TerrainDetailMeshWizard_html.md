* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailMeshWizard.html
...
**Note:** that this method derives from TerrainWizard. Additional resources: [TerrainWizard](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainWizard.html), DetailTextureWizard 
### Public Methods
Method | Description  
---|---  
[OnEnable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailMeshWizard.OnEnable.html) | Unity calls this method automatically when the detail mesh wizard is enabled.  
[ResetDefaults](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailMeshWizard.ResetDefaults.html) | Initializes the mesh detail wizard's defaults.  
### Inherited Members
### Static Properties
