* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailTextureWizard.html

# TerrainDetailTextureWizard
class in UnityEditor
/
Inherits from:[TerrainWizard](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainWizard.html)
Leave feedback
Suggest a change
## Success!
...
**Note:** This method derives from TerrainWizard. Additional resources: [TerrainWizard](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainWizard.html), DetailMeshWizard 
### Public Methods
Method | Description  
---|---  
[OnEnable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailTextureWizard.OnEnable.html) | Unity calls this method automatically when the detail mesh wizard is enabled.  
[ResetDefaults](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainDetailTextureWizard.ResetDefaults.html) | Initializes the texture detail wizard's defaults.  
### Inherited Members
### Static Properties
...
[ResetDefaults](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainWizard.ResetDefaults.html) | Initializes the terrain wizard defaults.  
### Protected Methods
Method | Description  
---|---  
...
[DisplayTerrainWizard](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TerrainWizard.DisplayTerrainWizard.html) | Displays the terrain wizard.  
### Operators
