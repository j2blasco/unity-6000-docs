* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Presets.PresetSelector.html
...
Cancel
### Description
This class implements a modal window that selects a [Preset](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Presets.Preset.html) asset from the Project.
### Static Methods
Method | Description  
---|---  
[DrawPresetButton](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Presets.PresetSelector.DrawPresetButton.html) | Draw a Preset button that opens the default PresetSelector using the targets array.  
[ShowSelector](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Presets.PresetSelector.ShowSelector.html) | Opens a modal window to select a Preset.  
### Inherited Members
### Static Properties
