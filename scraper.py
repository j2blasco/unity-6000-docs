...
async def main():
    ...
    config = CrawlerRunConfig(
        ...
        target_elements=["div.content-block"],
        excluded_tags=["footer", "div.feedbackbox"],
    ...
    async with AsyncWebCrawler() as crawler:
        ...
        # Handle results as a list (deep crawling returns multiple results)
        if isinstance(results, list):
            print(f"Found {len(results)} pages to process")
