* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.html

**Experimental** : this API is experimental and might be changed or removed in the future.
# StackNode
class in UnityEditor.Experimental.GraphView
/
Inherits from:[Experimental.GraphView.Node](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.html)
Leave feedback
  

Implements interfaces:[IDropTarget](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IDropTarget.html)
Suggest a change
## Success!
...
---|---  
[contentContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-contentContainer.html) | The content container of this StackNode.  
[dragEntered](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-dragEntered.html) | Indicates if items from this stack are currently being dragged.  
[dropPreviewTemplate](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-dropPreviewTemplate.html) | Use this property to customize the preview that appears when GraphElements are dragged over the StackNode.  
[hasMultipleSelectionSupport](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-hasMultipleSelectionSupport.html) | Returns true if the StackNode supports multiselection.  
[headerContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-headerContainer.html) | Use this property to customize the header for this StackNode.  
### Constructors
Constructor | Description  
---|---  
[StackNode](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode-ctor.html) | StackNode constructor.  
### Public Methods
Method | Description  
---|---  
[AddElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.AddElement.html) | Adds the specified GraphElement to the StackNode.  
[CanAcceptDrop](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.CanAcceptDrop.html) | Indicates whether this StackNode accepts the current drop event.  
[CollectElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.CollectElements.html) | Retrieves the set of nodes contained in this stack and its edges. The retrieved graph elements match a specific condition.  
[DragEnter](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.DragEnter.html) | This method is automatically called when a drag leave event occurs.  
[DragExited](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.DragExited.html) | This method is automatically called when a drag exit event occurs.  
[DragLeave](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.DragLeave.html) | This method is automatically called when a drag leave event occurs.  
[DragPerform](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.DragPerform.html) | This method is automatically called when a drop event occurs.  
[DragUpdated](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.DragUpdated.html) | This method is automatically called when a drag updated event occurs.  
[GetInsertionIndex](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.GetInsertionIndex.html) | Retrieves the insertion index in the StackNode if an item is dropped at the specified world position.  
[InsertElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.InsertElement.html) | Inserts the specified GraphElement at the specified index in this StackNode.  
[OnStartDragging](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.OnStartDragging.html) | This method is automatically called when an element of the stack is about to be dragged out of it.  
[RemoveElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.RemoveElement.html) | Removes the specified GraphElement from this StackNode.  
### Protected Methods
Method | Description  
---|---  
[AcceptsElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.AcceptsElement.html) | Checks whether the specified GraphElement can be added to this StackNode.  
[OnCustomStyleResolved](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.OnCustomStyleResolved.html) | Called when the custom style properties are resolved.  
[OnSeparatorContextualMenuEvent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.StackNode.OnSeparatorContextualMenuEvent.html) | This method is automatically called when a contextual menu is about to appear on a StackNode separator.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
...
[expanded](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-expanded.html) | Is node expanded.  
[extensionContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-extensionContainer.html) | Empty container used to display custom elements. After adding elements, call RefreshExpandedState in order to toggle this container visibility.  
[inputContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-inputContainer.html) | Input container used for input ports.  
[mainContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-mainContainer.html) | Main container that includes all other containers.  
[outputContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-outputContainer.html) | Outputs container, used for output ports.  
[title](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-title.html) | Node's title element.  
[titleButtonContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-titleButtonContainer.html) | Title bar button container. Contains the top right buttons.  
[titleContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-titleContainer.html) | Title bar container.  
[topContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node-topContainer.html) | Entire top area containing input and output containers.  
...
[HitTest](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.GraphElement.HitTest.html) | See if point is over the GraphElement.  
...
[BuildContextualMenu](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.BuildContextualMenu.html) | Add menu items to the node contextual menu.  
[InstantiatePort](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.InstantiatePort.html) | Create a new port specific to this node.  
[RefreshExpandedState](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.RefreshExpandedState.html) | After adding custom elements to the extensionContainer, call this method in order for them to become visible.  
[RefreshPorts](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.RefreshPorts.html) | Refresh the layout of the ports.  
[SetPosition](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.SetPosition.html) | Set node position.  
...
[OnPortRemoved](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.OnPortRemoved.html) | Called when port is remove.  
[ToggleCollapse](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.ToggleCollapse.html) | Toggle node's collapse state.  
[UseDefaultStyling](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Node.UseDefaultStyling.html) | Applies the default styling of Node. This must be explicitly called by Node subclasses that use their own uxml files.  
* * *
