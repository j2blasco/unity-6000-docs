* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.SearchExpression.GetNumberValue.html

#  [SearchExpression](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.SearchExpression.html).GetNumberValue
Leave feedback
Suggest a change
## Success!
...
### Returns
**double** Returns a numerical representation of the expression. 
### Description
Try to parse the innerText and convert it to a double value.
```
