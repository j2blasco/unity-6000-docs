* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D.html
...
Cancel
### Description
Joint that attempts to keep two [Rigidbody2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rigidbody2D.html) objects a set distance apart by applying a force between them.
...
---|---  
[autoConfigureDistance](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D-autoConfigureDistance.html) | Should the distance be calculated automatically?  
[dampingRatio](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D-dampingRatio.html) | The amount by which the spring force is reduced in proportion to the movement speed.  
[distance](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D-distance.html) | The distance the spring will try to keep between the two objects.  
[frequency](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D-frequency.html) | The frequency at which the spring oscillates around the distance distance between the objects.  
### Inherited Members
### Properties
Property | Description  
---|---  
