* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.DropdownField.html
...
Cancel
### Description
A control that allows the user to pick a choice from a list of options. For more information, refer to [UXML element DropdownField](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-DropdownField.html). 
### Constructors
Constructor | Description  
---|---  
[DropdownField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.DropdownField-ctor.html) |  Construct an empty DropdownField.   
### Inherited Members
### Static Properties
