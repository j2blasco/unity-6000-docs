* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.html
...
Cancel
### Description
Class for handling cube maps, Use this to create or modify existing [cube map assets](https://docs.unity3d.com/6000.0/Documentation/Manual/class-Cubemap.html).
This class does not support Cubemap creation with a Crunch compression [TextureFormat](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/TextureFormat.html).
### Properties
Property | Description  
---|---  
[desiredMipmapLevel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-desiredMipmapLevel.html) | The mipmap level that the streaming system would load before memory budgets are applied.  
[format](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-format.html) | The format of the pixel data in the texture (Read Only).  
[loadedMipmapLevel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-loadedMipmapLevel.html) | The mipmap level that is currently loaded by the streaming system.  
[loadingMipmapLevel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-loadingMipmapLevel.html) | The mipmap level that the mipmap streaming system is in the process of loading.  
[requestedMipmapLevel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-requestedMipmapLevel.html) | The mipmap level to load.  
[streamingMipmaps](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-streamingMipmaps.html) | Determines whether mipmap streaming is enabled for this Texture.  
[streamingMipmapsPriority](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-streamingMipmapsPriority.html) | Sets the relative priority for this Texture when reducing memory size to fit within the memory budget.  
### Constructors
Constructor | Description  
---|---  
[Cubemap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap-ctor.html) | Create a new empty cubemap texture.  
### Public Methods
Method | Description  
---|---  
[Apply](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.Apply.html) | Copies changes you've made in a CPU texture to the GPU.  
[ClearRequestedMipmapLevel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.ClearRequestedMipmapLevel.html) | Resets the requestedMipmapLevel field.  
[CopyPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.CopyPixels.html) | Copies pixel data from another texture on the CPU.  
[GetPixel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.GetPixel.html) | Gets the pixel color at coordinates (x, y).  
[GetPixelData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.GetPixelData.html) | Gets the raw data from a texture.  
[GetPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.GetPixels.html) | Gets the pixel color data for a mipmap level of a face as Color structs.  
[IsRequestedMipmapLevelLoaded](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.IsRequestedMipmapLevelLoaded.html) | Checks to see whether the mipmap level set by requestedMipmapLevel has finished loading.  
[SetPixel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.SetPixel.html) | Sets the pixel color at coordinates (x,y).  
[SetPixelData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.SetPixelData.html) | Sets the raw data of an entire mipmap level of a face directly in CPU memory.  
[SetPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.SetPixels.html) | Sets the pixel colors of an entire mipmap level of a face.  
[SmoothEdges](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.SmoothEdges.html) | Performs smoothing of near edge regions.  
[UpdateExternalTexture](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.UpdateExternalTexture.html) | Updates Unity cubemap to use different native cubemap texture object.  
### Static Methods
Method | Description  
---|---  
[CreateExternalTexture](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Cubemap.CreateExternalTexture.html) | Creates a Unity cubemap out of externally created native cubemap object.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
