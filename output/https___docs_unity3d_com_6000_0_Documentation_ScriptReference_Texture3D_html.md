* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.html
...
### Description
Class for handling 3D Textures, Use this to create [3D texture assets](https://docs.unity3d.com/6000.0/Documentation/Manual/class-Texture3D.html).
3D textures are commonly used as lookup tables by shaders, or to represent volumetric data.  
  
Typically you'd create a 3D texture, fill it up with data ([SetPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixels.html) or [SetPixels32](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixels32.html)) and call [Apply](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.Apply.html) to upload the data to the GPU.  
...
---|---  
[depth](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D-depth.html) | The depth of the texture (Read Only).  
[format](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D-format.html) | The format of the pixel data in the texture (Read Only).  
### Constructors
Constructor | Description  
---|---  
[Texture3D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D-ctor.html) | Create a new empty 3D Texture.  
### Public Methods
Method | Description  
---|---  
[Apply](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.Apply.html) | Copies changes you've made in a CPU texture to the GPU.  
[CopyPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.CopyPixels.html) | Copies pixel data from another texture on the CPU.  
[GetPixel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.GetPixel.html) | Gets the pixel color at coordinates (x, y, z).  
[GetPixelBilinear](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.GetPixelBilinear.html) | Gets the filtered pixel color at the normalized coordinates (u, v, w).  
[GetPixelData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.GetPixelData.html) | Gets the raw data from a texture.  
[GetPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.GetPixels.html) | Gets the pixel color data for a mipmap level as Color structs.  
[GetPixels32](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.GetPixels32.html) | Gets the pixel color data for a mipmap level as Color32 structs.  
[SetPixel](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixel.html) | Sets the pixel color at coordinates (x, y, z).  
[SetPixelData](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixelData.html) | Sets the raw data of an entire mipmap level directly in CPU memory.  
[SetPixels](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixels.html) | Sets the pixel colors of an entire mipmap level.  
[SetPixels32](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.SetPixels32.html) | Sets the pixel colors of an entire mipmap level.  
[UpdateExternalTexture](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.UpdateExternalTexture.html) | Updates Unity texture to use different native texture object.  
### Static Methods
Method | Description  
---|---  
[CreateExternalTexture](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Texture3D.CreateExternalTexture.html) | Creates Unity Texture out of externally created native texture object.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
