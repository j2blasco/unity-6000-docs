* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarPopupSearchField.html

# ToolbarPopupSearchField
class in UnityEditor.UIElements
/
Inherits from:[UIElements.ToolbarSearchField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField.html)
Leave feedback
  

Implements interfaces:[IToolbarMenuElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.IToolbarMenuElement.html)
Suggest a change
## Success!
...
Cancel
### Description
The pop-up search field for the toolbar. The search field includes a menu button. For more information, refer to [UXML element ToolbarPopupSearchField](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-ToolbarPopupSearchField.html). 
### Properties
Property | Description  
---|---  
[menu](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarPopupSearchField-menu.html) |  The menu used by the pop-up search field element.   
### Constructors
Constructor | Description  
---|---  
[ToolbarPopupSearchField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarPopupSearchField-ctor.html) |  Constructor.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
[cancelButtonOffVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-cancelButtonOffVariantUssClassName.html) |  USS class name of cancel buttons in elements of this type, when they are off.   
[cancelButtonUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-cancelButtonUssClassName.html) |  USS class name of cancel buttons in elements of this type.   
[popupVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-popupVariantUssClassName.html) |  USS class name of elements of this type, when they are using a popup menu.   
[searchButtonUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-searchButtonUssClassName.html) |  USS class name of search buttons in elements of this type.   
[textInputUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-textInputUssClassName.html) |  USS class name of text input elements in elements of this type.   
[textUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-textUssClassName.html) |  USS class name of text elements in elements of this type.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-ussClassName.html) |  USS class name of elements of this type.   
[cancelButtonOffVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-cancelButtonOffVariantUssClassName.html) |  USS class name of cancel buttons in elements of this type, when they are off.   
[cancelButtonUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-cancelButtonUssClassName.html) |  USS class name of cancel buttons in elements of this type.   
[popupVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-popupVariantUssClassName.html) |  USS class name of elements of this type, when they are using a popup menu.   
[searchButtonUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-searchButtonUssClassName.html) |  USS class name of search buttons in elements of this type.   
[textUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-textUssClassName.html) |  USS class name of text elements in elements of this type.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-ussClassName.html) |  USS class name of elements of this type.   
...
[placeholderText](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-placeholderText.html) |  A short hint to help users understand what to enter in the field.   
[searchButton](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-searchButton.html) |  The search button.   
[value](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2-value.html) |  The object currently being exposed by the field.   
[searchButton](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField-searchButton.html) |  The search button.   
...
[SetValueWithoutNotify](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2.SetValueWithoutNotify.html) |  Sets the value for the toolbar search field without sending a change event.   
...
[ClearTextField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2.ClearTextField.html) |  Method used when clearing the text field. You should usually clear the value when overriding the method.   
[FieldIsEmpty](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.SearchFieldBase_2.FieldIsEmpty.html) |  Tells if the field is empty. That meaning depends on the type of T.   
[ClearTextField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField.ClearTextField.html) |  Removes the text when clearing the field.   
[FieldIsEmpty](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ToolbarSearchField.FieldIsEmpty.html) |  Tells if the string is null or empty.   
* * *
