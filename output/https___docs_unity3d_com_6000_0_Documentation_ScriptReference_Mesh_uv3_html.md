* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh-uv3.html

#  [Mesh](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.html).uv3
Leave feedback
Suggest a change
## Success!
...
This channel is also commonly called "UV2". It maps to the shader semantic `TEXCOORD2`. When you call [Mesh.HasVertexAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.HasVertexAttribute.html), this channel corresponds to [VertexAttribute.TexCoord2](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rendering.VertexAttribute.TexCoord2.html).  
  
Unity can use this channel to store input UVs that it uses to calculate the final UVs for real-time lightmaps. For more information, see [Lightmap UVs](https://docs.unity3d.com/6000.0/Documentation/Manual/LightingGiUvs.html).  
  
**Note:** When Unity renders a [MeshRenderer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MeshRenderer.html) that references this mesh and uses Realtime Global Illumination, Unity streams the data in [MeshRenderer.enlightenVertexStream](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MeshRenderer-enlightenVertexStream.html) to `TEXCOORD2` instead of the data in this channel. For more information, see [Lightmap UVs](https://docs.unity3d.com/6000.0/Documentation/Manual/LightingGiUvs.html).  
