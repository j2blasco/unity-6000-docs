* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge.html
...
---|---  
[alignment](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-alignment.html) | Relative alignment between the badge and its target. The alignment will influence icon and tip position.  
[badgeText](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-badgeText.html) | Text displayed next to the badge on mouse hover.  
[distance](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-distance.html) | Distance between the badge and its target element.  
[target](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-target.html) | Target element to which this badge is attached.  
[visualStyle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-visualStyle.html) | The visual style for the badge. Built-in values are "error" and "comment".  
### Constructors
Constructor | Description  
---|---  
[IconBadge](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge-ctor.html) | Creates a basic comment badge.  
### Public Methods
Method | Description  
---|---  
[AttachTo](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge.AttachTo.html) | Attaches this badge to another element.  
[Detach](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge.Detach.html) | Detaches this badge from its target.  
### Static Methods
Method | Description  
---|---  
[CreateComment](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge.CreateComment.html) | Creates an IconBadge with the "comment" visual style.  
[CreateError](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.IconBadge.CreateError.html) | Creates an IconBadge with the "error" visual style.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
