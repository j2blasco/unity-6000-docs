* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D.html
...
Additional resources: [DistanceJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/DistanceJoint2D.html), [SliderJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SliderJoint2D.html), [SpringJoint2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SpringJoint2D.html), [JointAngleLimits2D](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/JointAngleLimits2D.html).
### Properties
Property | Description  
---|---  
[jointAngle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-jointAngle.html) | The current joint angle (in degrees) with respect to the reference angle.  
[jointSpeed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-jointSpeed.html) | The current joint speed.  
[limits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-limits.html) | Limit of angular rotation (in degrees) on the joint.  
[limitState](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-limitState.html) | Gets the state of the joint limit.  
[motor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-motor.html) | Parameters for the motor force applied to the joint.  
[referenceAngle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-referenceAngle.html) | The angle (in degrees) referenced between the two bodies used as the constraint for the joint.  
[useConnectedAnchor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-useConnectedAnchor.html) | Controls whether the connected anchor is used or not.  
[useLimits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-useLimits.html) | Should limits be placed on the range of rotation?  
[useMotor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D-useMotor.html) | Should the joint be rotated automatically by a motor torque?  
### Public Methods
Method | Description  
---|---  
[GetMotorTorque](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint2D.GetMotorTorque.html) | Gets the motor torque of the joint given the specified timestep.  
### Inherited Members
### Properties
Property | Description  
---|---  
