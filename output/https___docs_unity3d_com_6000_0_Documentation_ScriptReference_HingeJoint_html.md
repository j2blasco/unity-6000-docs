* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint.html
...
---|---  
[angle](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-angle.html) | The current angle in degrees of the joint relative to its rest position. (Read Only)  
[extendedLimits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-extendedLimits.html) | If enabled, the angle of the hinge is extended to [-360, 360] degrees.  
[limits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-limits.html) | Limit of angular rotation (in degrees) on the hinge joint.  
[motor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-motor.html) | The motor will apply a force up to a maximum force to achieve the target velocity in degrees per second.  
[spring](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-spring.html) | The spring attempts to reach a target angle by adding spring and damping forces.  
[useAcceleration](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-useAcceleration.html) | Defines whether the HingeJoint.spring outputs accelerations instead of forces.  
[useLimits](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-useLimits.html) | Enables the joint's limits. Disabled by default.  
[useMotor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-useMotor.html) | Enables the joint's motor. Disabled by default.  
[useSpring](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-useSpring.html) | Enables the joint's spring. Disabled by default.  
[velocity](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/HingeJoint-velocity.html) | The angular velocity of the joint in degrees per second. (Read Only)  
### Inherited Members
### Properties
Property | Description  
---|---  
