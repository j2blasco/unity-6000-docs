* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField.html
...
Cancel
### Description
Makes a field for selecting a color. For more information, refer to [UXML element ColorField](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-ColorField.html). 
### Static Properties
Property | Description  
---|---  
[colorContainerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-colorContainerUssClassName.html) |  USS class name of color container elements in elements of this type.   
[colorUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-colorUssClassName.html) |  USS class name of color elements in elements of this type.   
[eyeDropperUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-eyeDropperUssClassName.html) |  USS class name of eyedropper elements in elements of this type.   
[gradientContainerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-gradientContainerUssClassName.html) |  USS class name of gradient container elements in elements of this type.   
[hdrLabelUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-hdrLabelUssClassName.html) |  USS class name of hdr label elements in elements of this type.   
[inputUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-inputUssClassName.html) |  USS class name of input elements in elements of this type.   
[labelUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-labelUssClassName.html) |  USS class name of labels in elements of this type.   
[mixedValueColorUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-mixedValueColorUssClassName.html) |  USS class name of color elements in elements of this type when showing mixed values.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-ussClassName.html) |  USS class name of elements of this type.   
### Properties
Property | Description  
---|---  
[hdr](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-hdr.html) |  If true, treats the color as an HDR value. If false, treats the color as a standard LDR value.   
[showAlpha](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-showAlpha.html) |  If true, allows the user to set an alpha value for the color. If false, hides the alpha component.   
[showEyeDropper](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-showEyeDropper.html) |  If true, the color picker will show the eyedropper control. If false, the color picker won't show the eyedropper control.   
### Constructors
Constructor | Description  
---|---  
[ColorField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ColorField-ctor.html) |  Initializes and returns an instance of ColorField.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
