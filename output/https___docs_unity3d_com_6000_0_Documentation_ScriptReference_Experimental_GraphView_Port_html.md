* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.html
...
---|---  
[allowMultiDrag](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-allowMultiDrag.html) | When this property is set to true, you can select multiple edges connected to this port, and drag them all at the same time (for example, to disconnect them and reconnect them to another port). When this property is set to false, you can only drag one connected edge at a time.  
[capacity](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-capacity.html) | Specify how many edges a port can have connected.  
[collapsed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-collapsed.html) | Port's collapsed state.  
[connected](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-connected.html) | Port's connected state.  
[connections](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-connections.html) | All the port's current connections.  
[direction](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-direction.html) | Port's direction.  
[disabledPortColor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-disabledPortColor.html) | The color of the port when disabled.  
[edgeConnector](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-edgeConnector.html) | Reference to the edge connector.  
[highlight](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-highlight.html) | Is the port highlighted.  
[node](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-node.html) | Port's node.  
[orientation](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-orientation.html) | Port's orientation.  
[portCapLit](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-portCapLit.html) | Is the port cap lit or not.  
[portColor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-portColor.html) | The color of the port.  
[portName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-portName.html) | Port name.  
[portType](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-portType.html) | Port type.  
[showInMiniMap](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-showInMiniMap.html) | Whether the element is shown in the minimap. For Port, this property is always set to false.  
[source](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-source.html) | Port's source.  
[visualClass](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port-visualClass.html) | The name of the uss class to use to style the port.  
### Public Methods
Method | Description  
---|---  
[Connect](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.Connect.html) | Connect and edge to the port.  
[ConnectTo](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.ConnectTo.html) | Creates an edge between this port and the 'other' port.  
[ContainsPoint](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.ContainsPoint.html) | Check if point is on top of port. Used for selection and hover.  
[Disconnect](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.Disconnect.html) | Disconnect edge from port.  
[DisconnectAll](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.DisconnectAll.html) | Disconnect all edges from port.  
[GetGlobalCenter](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.GetGlobalCenter.html) | Get the port's center.  
[OnStartEdgeDragging](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.OnStartEdgeDragging.html) | Called when an edge is dragged.  
[OnStopEdgeDragging](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.OnStopEdgeDragging.html) | Called when an edge dragging ends.  
### Protected Methods
Method | Description  
---|---  
[OnCustomStyleResolved](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.OnCustomStyleResolved.html) | Called when the custom style properties are resolved.  
### Static Methods
Method | Description  
---|---  
[Create](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Port.Create.html) | Factory method for creating a port.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
