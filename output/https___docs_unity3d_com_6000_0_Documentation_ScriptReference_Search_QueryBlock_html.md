* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock.html
...
In example, `shader=lit` will be a query filter block with [QueryBlock.name](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-name.html) equal to `shader`, [QueryBlock.value](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-value.html) equal to `lit` and the [QueryBlock.op](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock-op.html) equal to `=`.
### Properties
...
Method | Description  
---|---  
[Apply](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Search.QueryBlock.Apply.html) | This method is invoked when a selected search proposition must be applied to the builder search query.  
