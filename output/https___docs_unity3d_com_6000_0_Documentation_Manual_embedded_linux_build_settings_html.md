* Source: https://docs.unity3d.com/6000.0/Documentation/Manual/embedded-linux-build-settings.html
...
# Embedded Linux build settings reference
Use the Embedded Linux build settings to configure and build your application for the Embedded Linux platform. The Embedded Linux build settings are part of the **Platform Settings** section of the [Build Profiles window](https://docs.unity3d.com/6000.0/Documentation/Manual/BuildSettings.html).
