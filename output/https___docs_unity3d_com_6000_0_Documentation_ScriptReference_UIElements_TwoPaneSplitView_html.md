* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView.html
...
---|---  
[fixedPane](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-fixedPane.html) |  The child element that is set as the fixed size pane.   
[fixedPaneIndex](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-fixedPaneIndex.html) |  0 for setting first child as the fixed pane, 1 for the second child element.   
[fixedPaneInitialDimension](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-fixedPaneInitialDimension.html) |  The initial width or height for the fixed pane.   
[flexedPane](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-flexedPane.html) |  The child element that is set as the flexable size pane.   
[orientation](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-orientation.html) |  Orientation of the split view.   
### Constructors
Constructor | Description  
---|---  
[TwoPaneSplitView](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView-ctor.html) |  Parameterized constructor.   
### Public Methods
Method | Description  
---|---  
[CollapseChild](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView.CollapseChild.html) |  Collapse one of the panes of the split view. This will hide the resizer and make the other child take up all available space.   
[UnCollapse](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TwoPaneSplitView.UnCollapse.html) |  Un-collapse the split view. This will restore the split view to the state it was before the previous collapse.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
