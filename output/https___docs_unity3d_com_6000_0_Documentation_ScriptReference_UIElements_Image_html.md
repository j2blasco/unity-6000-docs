* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image.html
...
Cancel
### Description
A [VisualElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.VisualElement.html) representing a source texture. 
Additional resources: [UXML element Image](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-Image.html).  
  
**Note** : This is the Image control for the UI Toolkit framework. This is not related to the [UnityEngine.UI.Image](https://docs.unity3d.com/Packages/com.unity.ugui@latest/index.html?subfolder=/api/UnityEngine.UI.Image.html)
### Static Properties
Property | Description  
---|---  
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-ussClassName.html) |  USS class name of elements of this type.   
### Properties
Property | Description  
---|---  
[image](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-image.html) |  The texture to display in this image. If you assign a Texture or Texture2D, the Image element will resize and show the assigned texture.   
[scaleMode](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-scaleMode.html) |  ScaleMode used to display the Image.   
[sourceRect](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-sourceRect.html) |  The source rectangle inside the texture relative to the top left corner.   
[sprite](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-sprite.html) |  The sprite to display in this image.   
[tintColor](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-tintColor.html) |  Tinting color for this Image.   
[uv](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-uv.html) |  The base texture coordinates of the Image relative to the bottom left corner.   
[vectorImage](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-vectorImage.html) |  The VectorImage to display in this image.   
### Constructors
Constructor | Description  
---|---  
[Image](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Image-ctor.html) |  Constructor.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
