* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AudioType.AIFF.html

#  [AudioType](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AudioType.html).AIFF
Leave feedback
Suggest a change
## Success!
...
public class AudioTypeExample : MonoBehaviour[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MonoBehaviour.html)
{
    ...
    IEnumerator GetAudioClip()
    {
        ...
        string url = "https://www.example.com/aiffsound.aiff";  
  
        // Stream audio, store it as an audio clip and play it. Make sure it has the AIFF audio format. 
