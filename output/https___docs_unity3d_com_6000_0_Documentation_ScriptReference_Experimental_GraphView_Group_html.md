* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.html

**Experimental** : this API is experimental and might be changed or removed in the future.
# Group
class in UnityEditor.Experimental.GraphView
/
Inherits from:[Experimental.GraphView.Scope](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.html)
Leave feedback
  

Implements interfaces:[ICollectibleElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.ICollectibleElement.html)
Suggest a change
## Success!
...
---|---  
[title](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group-title.html) | Title of the group.  
### Constructors
Constructor | Description  
---|---  
[Group](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group-ctor.html) | Group constructor.  
### Public Methods
Method | Description  
---|---  
[AcceptsElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.AcceptsElement.html) | Whether an element can be added to this group.  
[CollectElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.CollectElements.html) | Retrieves a set of graph elements that match a specified condition. The matching graph elements are selected from this group.  
[FocusTitleTextField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.FocusTitleTextField.html) | Focuses the title text field of this group, so that it's editable from the UI.  
### Protected Methods
Method | Description  
---|---  
[OnElementsAdded](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.OnElementsAdded.html) | Called when elements are added to this group.  
[OnElementsRemoved](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.OnElementsRemoved.html) | Called when elements are removed from this group.  
[OnGroupRenamed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Group.OnGroupRenamed.html) | Called when this group is renamed.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
...
[autoUpdateGeometry](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope-autoUpdateGeometry.html) | Enables or disables the automatic resizing and positioning of the Scope.  
[containedElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope-containedElements.html) | The list of GraphElements contained by the Scope.  
[containedElementsRect](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope-containedElementsRect.html) | The rect containing the GraphElements encompassed by the Scope. The rect is expressed in local coordinates.  
[headerContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope-headerContainer.html) | Returns the header container for the Scope. Use this header container to customizer the header of the Scope.  
...
[AddElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.AddElement.html) | Adds a GraphElement to the Scope.  
[AddElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.AddElements.html) | Adds GraphElements to the Scope.  
[ContainsElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.ContainsElement.html) | Determines if the Scope contains the specified GraphElement.  
[GetPosition](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.GetPosition.html) | Returns the geometry of the Scope.  
[HitTest](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.HitTest.html) | Determines whether the specified point is within the selectable area of the Scope.  
[Overlaps](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.Overlaps.html) | Determines whether the specified rect overlaps the Scope.  
[RemoveElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.RemoveElement.html) | Removes an element from the Scope.  
[RemoveElements](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.RemoveElements.html) | Removes elements from the Scope.  
[RemoveElementsWithoutNotification](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.RemoveElementsWithoutNotification.html) | Removes elements from the Scope but do not send a notification.  
[SetPosition](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.SetPosition.html) | Sets the geometry of the Scope.  
[UpdateGeometryFromContent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.UpdateGeometryFromContent.html) | Updates the size and position of the Scope based on its contents.  
...
[OnCustomStyleResolved](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.GraphElement.OnCustomStyleResolved.html) | Called when the custom style properties are resolved.  
[ScheduleUpdateGeometryFromContent](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.ScheduleUpdateGeometryFromContent.html) | Schedules the update of the size and position of the Scope based on its contents.  
[SetScopePositionOnly](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Experimental.GraphView.Scope.SetScopePositionOnly.html) | Change the position of the scope but does not move its elements.  
* * *
