* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.ApplyPluginList.html
...
For more information about the element, see Gradle's documentation: [Applying plugins](https://docs.gradle.org/current/userguide/plugins.html#sec:old_plugin_applicationy)
### Constructors
Constructor | Description  
---|---  
[ApplyPluginList](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.ApplyPluginList-ctor.html) | Element constructor.  
### Public Methods
Method | Description  
---|---  
[AddPluginByName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.ApplyPluginList.AddPluginByName.html) | Adds an apply plugin: '{name}' element to the block.  
[AddPluginRaw](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Unity.Android.Gradle.ApplyPluginList.AddPluginRaw.html) | Adds an apply plugin: {value} element to the block.  
### Inherited Members
### Public Methods
Method | Description  
---|---  
