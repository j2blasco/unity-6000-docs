* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color-grey.html

#  [Color](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color.html).grey
Leave feedback
Suggest a change
## Success!
...
[Color](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color.html) grey; 
### Description
English spelling for [gray](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color-gray.html). RGBA is the same (0.5, 0.5, 0.5, 1).
```
...
public class Example : MonoBehaviour[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MonoBehaviour.html)
{
    ...
    //Run your mouse over the GameObject[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/GameObject.html) to change the Renderer[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Renderer.html)'s material color to grey
    void OnMouseOver()
    {
        m_Renderer.material.color = Color.grey[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Color-grey.html);
    }  
