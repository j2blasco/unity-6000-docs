* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AudioType.MPEG.html

#  [AudioType](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AudioType.html).MPEG
Leave feedback
Suggest a change
## Success!
...
public class AudioTypeExample : MonoBehaviour[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/MonoBehaviour.html)
{
    ...
    IEnumerator GetAudioClip()
    {
        ...
        string url = "https://www.example.com/mpegsound.mp3";  
  
        // Stream audio, store it as an audio clip and play it. Make sure it has the MPEG audio format. 
