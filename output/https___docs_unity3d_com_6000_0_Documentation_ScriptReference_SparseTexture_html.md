* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture.html
...
Additional resources: [ Sparse Textures](https://docs.unity3d.com/6000.0/Documentation/Manual/SparseTextures.html).
### Properties
Property | Description  
---|---  
[isCreated](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture-isCreated.html) | Is the sparse texture actually created? (Read Only)  
[tileHeight](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture-tileHeight.html) | Get sparse texture tile height (Read Only).  
[tileWidth](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture-tileWidth.html) | Get sparse texture tile width (Read Only).  
### Constructors
Constructor | Description  
---|---  
[SparseTexture](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture-ctor.html) | Create a sparse texture.  
### Public Methods
Method | Description  
---|---  
[UnloadTile](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture.UnloadTile.html) | Unload sparse texture tile.  
[UpdateTile](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture.UpdateTile.html) | Update sparse texture tile with color values.  
[UpdateTileRaw](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SparseTexture.UpdateTileRaw.html) | Update sparse texture tile with raw pixel values.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
