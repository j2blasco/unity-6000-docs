* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh-uv7.html

#  [Mesh](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.html).uv7
Leave feedback
Suggest a change
## Success!
...
This channel is also commonly called "UV6". It maps to the shader semantic `TEXCOORD6`. When you call [Mesh.HasVertexAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Mesh.HasVertexAttribute.html), this channel corresponds to [VertexAttribute.TexCoord6](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Rendering.VertexAttribute.TexCoord6.html).  
