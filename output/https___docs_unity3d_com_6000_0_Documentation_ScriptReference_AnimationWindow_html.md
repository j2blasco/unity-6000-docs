* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow.html
...
The Animation window will update when selecting Animation clips in the Project window or game objects with Animation players (such as [Animator](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Animator.html) or [Animation](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Animation.html)) in the Scene hierarchy.
### Properties
Property | Description  
---|---  
[animationClip](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-animationClip.html) | The animation clip selected in the Animation window.  
[canPreview](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-canPreview.html) | True if Animation window can enable preview mode. False otherwise. (Read Only)  
[canRecord](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-canRecord.html) | True if Animation window can enable recording mode. False otherwise. (Read Only)  
[frame](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-frame.html) | The frame number at which the Animation window playhead is located.  
[playing](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-playing.html) | This property toggles animation playback in the Animation window.  
[previewing](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-previewing.html) | This property toggles previewing in the Animation window.  
[recording](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-recording.html) | This property toggles recording in the Animation window.  
[time](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AnimationWindow-time.html) | The time value at which the Animation window playhead is located.  
### Inherited Members
### Static Properties
Property | Description  
---|---  
