* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet.html
...
The [StyleSheet](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet.html) class holds the imported data of USS files in your project. Once loaded, a style sheet can be attached to a [VisualElement](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.VisualElement.html) object to affect the element itself and its descendants.   
...
```
 public class MyEditorWindow : EditorWindow[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/EditorWindow.html)
 {
     void OnEnable()
     {
         rootVisualElement.styleSheets.Add(AssetDatabase.LoadAssetAtPath[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/AssetDatabase.LoadAssetAtPath.html)<StyleSheet[](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet.html)>("Assets/styles.uss"));
     }
 }
...
---|---  
[contentHash](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet-contentHash.html) |  A hash value computed from the stylesheet content.   
[importedWithErrors](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet-importedWithErrors.html) |  Whether there were errors encountered while importing the StyleSheet   
[importedWithWarnings](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.StyleSheet-importedWithWarnings.html) |  Whether there were warnings encountered while importing the StyleSheet   
### Inherited Members
### Properties
Property | Description  
---|---  
