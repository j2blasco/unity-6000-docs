* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.PlayableAsset.html
...
Implements interfaces:[IPlayableAsset](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.IPlayableAsset.html)
Suggest a change
## Success!
...
Cancel
### Description
A base class for assets that can be used to instantiate a [Playable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.Playable.html) at runtime.
### Properties
Property | Description  
---|---  
[duration](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.PlayableAsset-duration.html) | The playback duration in seconds of the instantiated Playable.  
[outputs](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.PlayableAsset-outputs.html) | A description of the outputs of the instantiated Playable.  
### Public Methods
Method | Description  
---|---  
[CreatePlayable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Playables.PlayableAsset.CreatePlayable.html) | Implement this method to have your asset inject playables into the given graph.  
### Inherited Members
### Properties
Property | Description  
---|---  
