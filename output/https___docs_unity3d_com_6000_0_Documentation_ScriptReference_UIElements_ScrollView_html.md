* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView.html
...
Cancel
### Description
Displays its contents inside a scrollable frame. For more information, see [ScrollView](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-ScrollView.html). 
### Static Properties
Property | Description  
---|---  
[contentAndVerticalScrollUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-contentAndVerticalScrollUssClassName.html) |  USS class name of content elements in elements of this type.   
[contentUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-contentUssClassName.html) |  USS class name of content elements in elements of this type.   
[horizontalVariantContentUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalVariantContentUssClassName.html) |  USS class name that's added when the ContentContainer is in horizontal mode. ScrollViewMode.Horizontal  
[horizontalVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalVariantUssClassName.html) |  USS class name that's added when the ScrollView is in horizontal mode. ScrollViewMode.Horizontal  
[horizontalVariantViewportUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalVariantViewportUssClassName.html) |  USS class name that's added when the Viewport is in horizontal mode. ScrollViewMode.Horizontal  
[hScrollerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-hScrollerUssClassName.html) |  USS class name of horizontal scrollers in elements of this type.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-ussClassName.html) |  USS class name of elements of this type.   
[verticalHorizontalVariantContentUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalHorizontalVariantContentUssClassName.html) |  USS class name that's added when the ContentContainer is in both horizontal and vertical mode. ScrollViewMode.VerticalAndHorizontal  
[verticalHorizontalVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalHorizontalVariantUssClassName.html) |  USS class name that's added when the ScrollView is in both horizontal and vertical mode. ScrollViewMode.VerticalAndHorizontal  
[verticalHorizontalVariantViewportUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalHorizontalVariantViewportUssClassName.html) |  USS class name that's added when the Viewport is in both horizontal and vertical mode. ScrollViewMode.VerticalAndHorizontal  
[verticalVariantContentUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalVariantContentUssClassName.html) |  USS class name that's added when the ContentContainer is in vertical mode. ScrollViewMode.Vertical  
[verticalVariantUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalVariantUssClassName.html) |  USS class name that's added when the ScrollView is in vertical mode. ScrollViewMode.Vertical  
[verticalVariantViewportUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalVariantViewportUssClassName.html) |  USS class name that's added when the Viewport is in vertical mode. ScrollViewMode.Vertical  
[viewportUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-viewportUssClassName.html) |  USS class name of viewport elements in elements of this type.   
[vScrollerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-vScrollerUssClassName.html) |  USS class name of vertical scrollers in elements of this type.   
### Properties
Property | Description  
---|---  
[contentContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-contentContainer.html) |  Contains full content, potentially partially visible.   
[contentViewport](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-contentViewport.html) |  Represents the visible part of contentContainer.   
[elasticAnimationIntervalMs](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-elasticAnimationIntervalMs.html) |  The minimum amount of time, in milliseconds, between executions of elastic spring animation.   
[elasticity](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-elasticity.html) |  The amount of elasticity to use when a user tries to scroll past the boundaries of the scroll view.   
[horizontalPageSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalPageSize.html) |  This property controls the speed of the horizontal scrolling when using a keyboard or the on-screen scrollbar buttons (arrows and handle), based on the size of the page.   
[horizontalScroller](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalScroller.html) |  Horizontal scrollbar.   
[horizontalScrollerVisibility](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-horizontalScrollerVisibility.html) |  Specifies whether the horizontal scroll bar is visible.   
[mode](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-mode.html) |  Controls how the ScrollView allows the user to scroll the contents. ScrollViewMode  
[mouseWheelScrollSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-mouseWheelScrollSize.html) |  This property controls the scrolling speed only when using a mouse scroll wheel, based on the size of the page. It takes precedence over the --unity-metrics-single_line-height USS variable.   
[nestedInteractionKind](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-nestedInteractionKind.html) |  The behavior to use when scrolling reaches limits of a nested ScrollView.   
[scrollDecelerationRate](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-scrollDecelerationRate.html) |  Controls the rate at which the scrolling movement slows after a user scrolls using a touch interaction.   
[scrollOffset](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-scrollOffset.html) |  The current scrolling position.   
[touchScrollBehavior](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-touchScrollBehavior.html) |  The behavior to use when a user tries to scroll past the boundaries of the ScrollView content using a touch interaction.   
[verticalPageSize](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalPageSize.html) |  This property controls the speed of the vertical scrolling when using a keyboard or the on-screen scrollbar buttons (arrows and handle), based on the size of the page.   
[verticalScroller](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalScroller.html) |  Vertical Scrollbar.   
[verticalScrollerVisibility](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-verticalScrollerVisibility.html) |  Specifies whether the vertical scroll bar is visible.   
### Constructors
Constructor | Description  
---|---  
[ScrollView](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView-ctor.html) |  Constructor.   
### Public Methods
Method | Description  
---|---  
[ScrollTo](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.ScrollView.ScrollTo.html) |  Scroll to a specific child element.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
