* Source: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView.html
...
Cancel
### Description
Creates a tab view that groups a one or more [Tab](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.Tab.html) elements. 
...
For more information, refer to [UXML element TabView](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-uxml-element-TabView.html). 
### Static Properties
Property | Description  
---|---  
[contentContainerUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-contentContainerUssClassName.html) |  USS class name for the content container of this type.   
[headerContainerClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-headerContainerClassName.html) |  USS class name for the header container of this type.   
[reorderableUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-reorderableUssClassName.html) |  The USS class name for reorderable tab view.   
[ussClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-ussClassName.html) |  USS class name of elements of this type.   
[verticalUssClassName](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-verticalUssClassName.html) |  The USS class name for vertical tab view.   
### Properties
Property | Description  
---|---  
[activeTab](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-activeTab.html) |  Property that holds the current active tab.   
[contentContainer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-contentContainer.html) |  The container for the content of the TabView.   
[reorderable](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-reorderable.html) |  A property that adds dragging support to tabs.   
[selectedTabIndex](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-selectedTabIndex.html) |  A property that returns the index of current active tab inside a list of available tabs.   
### Constructors
Constructor | Description  
---|---  
[TabView](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-ctor.html) |  Constructs a TabView.   
### Public Methods
Method | Description  
---|---  
[GetTab](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView.GetTab.html) |  Returns the tab at the specified index.   
[GetTabHeader](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView.GetTabHeader.html) |  Returns the tab header at the specified index.   
[ReorderTab](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView.ReorderTab.html) |  Moves the tab from the specified index to a new index.   
### Events
Event | Description  
---|---  
[activeTabChanged](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-activeTabChanged.html) |  Called when the active tab is reassigned.   
[tabClosed](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-tabClosed.html) |  Raised when a tab is closed. The first argument is the tab that was closed, the second is the index of the tab that was closed.   
[tabReordered](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.TabView-tabReordered.html) |  Raised when a tab is reordered. The first argument is source index, second is destination index.   
### Inherited Members
### Static Properties
Property | Description  
---|---  
